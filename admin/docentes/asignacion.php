...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Listado del personal terapeutico asignado a Diagnósticos</h1>
            </div>
            <br>
            <div class="row">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_asignarcion">
                                    <i class="bi bi-plus-square"></i> Asignar Diagnóstico
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <th><center>Diagnóstico asignado</center></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                        ...
                                        <td>
                                            <center>
                                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_materias<?=$id_docente;?>">
                                                    <i class="bi bi-postcard"></i> Ver Diagnóstico
                                                </button>
                                            </center>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header" style="background-color: #0aa8ba">
                                                            <h5 class="modal-title" id="exampleModalLabel"><b>Diagnóstico asignado</b></h5>
                                                                                        ...
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header" style="background-color: #0fbf0c">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel"><b>Asignación de Diagnóstico</b></h5>
                                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                        <span aria-hidden="true">&times;</span>
                                                                                                    </button>
                                                                                                </div>
