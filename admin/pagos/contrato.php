...
<tr>
     ...
     <td style="text-align: center"><h2><b><u>INSCRIPCIÓN DE MATRÍCULA PSICOPEDAGÓGA PARA ESTUDIANTE DE '.$nivel.'</u></b></h2></td>
</tr>
</table>
...
Nuestro espacio psicopedagógico '.$nombre_institucion.', representada por el <b style="color: blue">Psp. Diana Coronado Figueroa</b>, con 
domicilio en Blvd. Las Quintas 01, Local E. y por otro lado los Padres/Tutores legales del paciente <b style="color: blue">'.$apellidos.' '.$nombres.'</b>, 
representados por <b style="color: blue">'.$nombres_apellidos_ppff.'</b>, con domicilio en <b style="color: blue">'.$direccion.'</b> declara conocer nuestras instalaciones y el historial de nuestro personal terapeutico, por lo que se encuentra de acuerdo para la impartición de terapias .
